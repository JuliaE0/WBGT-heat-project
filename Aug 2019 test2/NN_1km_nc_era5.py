...
# =========================
IN_DIR = "/Users/new account/Desktop/WBGT-heat-project/Aug 2019 test2/ERA5"
OUT_DIR = "/Users/new account/Desktop/WBGT-heat-project/Aug 2019 test2/ERA5_nn_interpolated"
...
def process_one_year(nc_path, tgt_lons, tgt_lats, bounds_wgs84):
    ...
    for varname in ERA5_VAR:
        ...
        print(f"Interpolating {varname} ({year_str})...")
    ...
    out_path = os.path.join(OUT_DIR, f"era5_nn_{year_str}.nc")
    ds_out.to_netcdf(out_path, encoding=encoding)
